...
beforeAll(async () => {
  ...
  const publishers: CreatePublisher[] = [
    {
      name: "publisher1",
      description: "publisher1",
      // logo: "publisher1", //ERROR: Copilot didn't get it right, it instists on logo, even when provided with the type
      // It seems to not have access to the file where the type is defined
  ...
  console.log("✨ 2 publishers created");
  ...
  describe("and the user is not authenticated", () => {
    it("should throw an error", async () => {
      ...
      const publisher: CreatePublisher = {
        ...
        coverImage: "publisher3",
        // logo: "publisher3", //ERROR: same as in line 23
      };
...
describe("When getting a publisher by Id", () => {
  describe("and the publisher does not exist", () => {
    it("should throw an error", async () => {
      ...
      // Act
      const result = caller.publisher.getById({ id: createId() });
  ...
  describe("and the publisher exists", () => {
    it("should return a publisher", async () => {
      ...
      const publisher: CreatePublisher = {
        ...
        coverImage: "publisher4", // Copilot got it right this time
      };
      ...
      const publishers: CreatePublisher[] = [
        {
          ...
          coverImage: "publisher5",
        },
        {
          name: "publisher6",
          description: "publisher6",
          coverImage: "publisher6",
        },
      ];
...
describe("When updating a publisher", () => {
  ...
  describe("and the publisher exists", () => {
    it("should update the publisher", async () => {
      ...
      const updatedPublisher = await caller.publisher.getById({ id: data.id });

      // Assert
      expect(result).toMatchObject(updatedPublisher);
    });
  });
});
